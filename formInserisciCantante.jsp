...
<html>
    <head>
        ...
        <title>Inserimento nuovo cantante</title>
    ...
    <body>
        ...
        <div class="container">
            <form action=inserisciCantante method=POST>
                <h3>Inserisci il nome del cantante:</h3>
                <input class="input" type=text name=nome /><br>
                <h3>Inserisci il cognome del cantante:</h3>
                <input class="input" type=text name=cognome /><br>
                <h3>Inserisci il luogo di nascita del giudice:</h3>
