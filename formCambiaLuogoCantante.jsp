...
<html>
    <head>
        ...
        <title>Cambia il luogo di nascita di un cantante.</title>
    ...
    <body>
        ...
        <form class="test" action=cambiaLuogoCantante method=POST>
            <input class="input" type=text name=cognome /><br>
            <h3>Inserisci il luogo di nascita del cantante:</h3><br>
