...
<html>
    <head>
        ...
        <title>Cambia il luogo di nascita di un giudice.</title>
    ...
    <body>
        ...
        <form class="test" action=cambiaLuogoGiudice method=POST>
            <input class="input" type=text name=cognome /><br>
            <h3>Inserisci il luogo di nascita di un giudice:</h3><br>
