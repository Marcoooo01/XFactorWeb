...
<html>
    <head>
        ...
        <title>Cambia il luogo di nascita di un presentatore.</title>
    ...
    <body>
        ...
        <form class="test" action=cambiaLuogoPresentatore method=POST>
            <input class="input" type=text name=cognome /><br>
            <h3>Inserisci il luogo di nascita del presentatore:</h3><br>
