...
<html>
    <head>
        ...
        <title>Inserimento nuovo presentatore</title>
    ...
    <body>
        ...
        <div class="container">
            <form action=inserisciPresentatore method=POST>
                <h3>Inserisci il nome del presentatore:</h3>
                <input class="input" type=text name=nome /><br>
                <h3>Inserisci il cognome del presentatore:</h3>
                <input class="input" type=text name=cognome /><br>
                <h3>Inserisci la citta di nascita del presentatore:</h3>
