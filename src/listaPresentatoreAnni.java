...
public class listaPresentatoreAnni extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("formListaPresentatoreAnni.jsp");
        view.forward(request, response);

        message = "Lista dei presentatori che hanno più di " + request.getParameter("anni") + " anni: <br>";
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SELECT * FROM Conduttore WHERE (DateDiff(year, DataDiNascita, GETDATE())) > ? ORDER BY Nome ASC";
            ...
            message = "Lista dei presentatori che hanno piu di " + anni + " anni: <br>";
            while (rs.next()) {
