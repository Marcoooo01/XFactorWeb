...
public class listaCantanteAnni extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        message = "Lista dei cantanti di XFactor che hanno più di una certa età:<br>";
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("formListaCantanteAnni.jsp");
        view.forward(request, response);

        message = "Lista dei cantanti che hanno più di " + request.getParameter("anni") + " anni: <br>";
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SELECT * FROM Cantante WHERE (DateDiff(year, DataDiNascita, GETDATE())) > ? ORDER BY Nome ASC";
