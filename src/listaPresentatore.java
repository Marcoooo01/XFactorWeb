...
public class listaPresentatore extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        message = "Lista dei pesentatori di XFactor di tutte le edizioni:<br>";
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SELECT * FROM Conduttore ORDER BY Nome ASC";
            ResultSet rs = stmt.executeQuery(sql);

            message = "Lista dei presentatori di XFactor di tutte le edizioni:<br>";
            while (rs.next()) {
