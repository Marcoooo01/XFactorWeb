...
public class luogoNascitaPresentatore extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("formLuogoNascitaPresentatore.jsp");
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql4a = "SELECT COUNT(ID) AS Numero FROM Conduttore WHERE LuogoDiNascita = ?";
            ...
            if (numero == 0) {
                ...
                String sql = "SELECT * FROM Conduttore where LuogoDiNascita = ?";
                ...
                message = "Presentatori nati a " + luogo + ": <br>";
                while (rs.next()) {
