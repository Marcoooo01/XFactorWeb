...
public class cambiaLuogoCantante extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("formCambiaLuogoCantante.jsp");
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql4a = "SELECT COUNT(ID) AS Numero FROM Cantante WHERE Cognome = ?";
            ...
            if (numero == 0) {
                ...
                String sql4 = "UPDATE Cantante SET LuogoDiNascita = ? WHERE Cognome = ? ";
                PreparedStatement prepStmt = connection.prepareStatement(sql4);
                prepStmt.setString(1, luogo);
                prepStmt.setString(2, cognome);
                prepStmt.executeUpdate();
                message = "Luogo di nascita del cantante cambiato";
            }
            connection.close();
        } catch (Exception e) {
            message = "Errore";
