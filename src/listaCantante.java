...
public class listaCantante extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        message = "Lista dei cantanti di XFactor di tutte le edizioni:<br>";
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SELECT * FROM Cantante ORDER BY Nome ASC";
