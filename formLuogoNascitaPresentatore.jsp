...
<html>
    <head>
        ...
        <title>Cerca presentatori per luogo di nascita</title>
    ...
    <body>
        ...
        <div class="container">
            <h3>Inserisci il luogo di nascita del presentatore:</h3>
            <form action=luogoNascitaPresentatore method=POST>
